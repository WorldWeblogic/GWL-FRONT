...
import { lowermanagernavbarLinks } from "../constants";

export const LowerManagerSidebar = forwardRef(({ collapsed }, ref) => {
    return (
        <aside
            ref={ref}
            className={cn(
        ...
        >
            ...
            <div className="flex w-full flex-col gap-y-4 overflow-y-auto overflow-x-hidden p-3 [scrollbar-width:_thin]">
                ...
                {lowermanagernavbarLinks.map((navbarLink,index) => (
                    <nav
                        key={index}
...
LowerManagerSidebar.displayName = "LowerManagerSidebar";
LowerManagerSidebar.propTypes = {
