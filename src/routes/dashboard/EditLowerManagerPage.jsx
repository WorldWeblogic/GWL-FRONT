...
const EditLowerManagerPage = () => {
    const { lowermanager,fetchlowermanagerData } = useAuth()
     useEffect(() => {
                            ...
                            <tr className="items-center">
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex h-12 items-center gap-3">
                                        <span className="dark:text-white">{lowermanager.firstname}{" "}{lowermanager.lastname}</span>
                                    </div>
                                </td>
                                <td className="px-4 py-3 dark:text-white">
                                    <div className="flex h-12 items-center">{lowermanager.email}</div>
                                </td>
                                <td className="px-4 py-3 dark:text-white">
                                    <div className="flex h-12 items-center">{lowermanager.managerid}</div>
                                </td>
                                <td className="px-4 py-3 dark:text-white">
                                    <div className="flex h-12 items-center">{lowermanager.phone}</div>
                                </td>
                                <td className="px-4 py-3">
                                    <div className="flex h-12 items-center gap-2">
                                        <Link to="/LowerManagerlayout/manage-manager"
                                            state={{
                                                managerId: lowermanager._id,
                                                manager_type: "lower_manager"
                                            }}
                                        >
...
export default EditLowerManagerPage;
