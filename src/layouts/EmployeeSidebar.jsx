...
import { employeenavbarLinks } from "../constants";

export const EmployeeSidebar = forwardRef(({ collapsed }, ref) => {
    return (
        <aside
            ref={ref}
            className={cn(
        ...
        >
            ...
            <div className="flex w-full flex-col gap-y-4 overflow-y-auto overflow-x-hidden p-3 [scrollbar-width:_thin]">
                ...
                {employeenavbarLinks.map((navbarLink,index) => (
                    <nav
                        key={index}
...
EmployeeSidebar.displayName = "EmployeeSidebar";
